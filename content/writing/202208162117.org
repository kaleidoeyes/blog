...
[[https://odinxu.com/post/hugo-use-aliyun-oss/][Hugo发布博客自动同步到阿里云OSS云存储 · OdinXu的博客]]

我对其主代码进行了改动，使支持删除OSS中多余的文件，并优化了本地md5检验方式。
...
[[https://help.aliyun.com/document_detail/52834.html][阿里云OSS & SDK]]
...
后记：关于删除文件的操作会打印信息，提示出错，但实际上可以正常进行，忽略即可。
